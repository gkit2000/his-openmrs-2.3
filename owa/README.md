...
This repository contains the openmrs-owa-idgen OpenMRS Open Web App.
...
This will create a file called `openmrs-owa-idgen.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/Users/denisjuma/Desktop/referenceapplication-standalone-2.6.0/appdata\\owa/`
...
```js
{
  "LOCAL_OWA_FOLDER": "/Users/denisjuma/Desktop/referenceapplication-standalone-2.6.0/appdata\\owa/"
}
```
...
{
  "LOCAL_OWA_FOLDER": "/Users/denisjuma/Desktop/referenceapplication-standalone-2.6.0/appdata\\owa/",
  "APP_ENTRY_POINT": "http://localhost:8081/openmrs-standalone/owa/openmrs-owa-idgen/index.html"
}
```
